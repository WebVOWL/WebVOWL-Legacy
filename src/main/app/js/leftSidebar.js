...
module.exports = function (graph) {
    ...
    let collapseButton = d3.select("#leftSideBarCollapseButton");
    let visibleSidebar = 0;
    let backupVisibility = 0;
    let sideBarContent = d3.select("#leftSideBarContent");
    let sideBarContainer = d3.select("#containerForLeftSideBar");
    let defaultClassSelectionContainers = [];
    let defaultDatatypeSelectionContainers = [];
    let defaultPropertySelectionContainers = [];
    ...
    leftSidebar.setup = function () {
        ...
        collapseButton.on("click", function (event) {
            ...
            let settingValue = parseInt(leftSidebar.getSidebarVisibility());
    ...
    function classSelectorFunction(event) {
    ...
    function setupSelectionContainers() {
        let classContainer = d3.select("#classContainer");
        let datatypeContainer = d3.select("#datatypeContainer");
        let propertyContainer = d3.select("#propertyContainer");
        ...
        let supportedClasses = graph.options().supportedClasses();
        let supportedDatatypes = graph.options().supportedDatatypes();
        let supportedProperties = graph.options().supportedProperties();
        let i;
        ...
        for (i = 0; i < supportedDatatypes.length; i++) {
            let aDTSelectionContainer = datatypeContainer.append("div");
        ...
        for (i = 0; i < supportedProperties.length; i++) {
            let aPropSelectionContainer = propertyContainer.append("div");
    ...
    leftSidebar.updateSideBarVis = function (init) {
        let vis = leftSidebar.getSidebarVisibility();
    ...
    leftSidebar.getSidebarVisibility = function () {
        let isHidden = sideBarContent.classed("hidden");
