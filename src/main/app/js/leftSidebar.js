export class LeftSideBar {
    ...
    #setupSelectionContainers() {
        ...
        for (const supportedClass of supportedClasses) {
            ...
            aClassSelectionContainer.node().id = "selectedClass" + supportedClass;
        ...
        for (const supportedDatatype of supportedDatatypes) {
            ...
            aDTSelectionContainer.node().id = "selectedDatatype" + supportedDatatype;
        ...
        for (const supportedProperty of supportedProperties) {
            ...
            aPropSelectionContainer.node().id = "selectedClass" + supportedProperty;
            ...
            this.defaultPropertySelectionContainers.push(aPropSelectionContainer);
        }
    }
    ...
    showSidebar(isVisible, init) {
        ...
        if (isVisible) {
            ...
            this.sideBarContainer.style("-webkit-animation-name", "l_sbExpandAnimation");
            ...
            this.sideBarContainer.style("-webkit-animation-name", "l_sbCollapseAnimation");
            this.sideBarContainer.style("-webkit-animation-duration", "0.5s");
