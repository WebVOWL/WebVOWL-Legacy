...
export default class Warnings {
    ...
    addMessageBox() {
        ...
        messageContainer.node().addEventListener("animationend", function () {
            _this.#_msgContainer_animationEnd(this)
        })
    ...
    #closeMessage(id) {
        ...
        for (let fc = 0; fc < followingChildren.length; fc++) {
            ...
            const superCss =
                document.styleSheets[this.styleSelectorIndex].cssRules[
                    this.cssStyleIndex
                ]
            try {
            ...
            child.node().addEventListener("animationend", function () {
                _this.#_child_animationEnd(this)
            })
        }
    }
    ...
    #_child_animationEnd(element) {
        ...
        // @ts-ignore
        c.node().removeEventListener("animationend", function () {
            _this.#_child_animationEnd(this)
        })
    }
