...
export default class GravityMenu {
        ...
        this.#addDistanceSlider(
            ...
            (val) => {
                if (!arguments.length)
                    ...
                    this.options.classDistance = val
            }
        );
        this.#addDistanceSlider(
            ...
            (val) => {
                if (!arguments.length)
                    ...
                    this.options.datatypeDistance = val
            }
        );
    }
    ...
    adjustCharge(defaultLinkDistance) {
        const greaterDistance = Math.max(this.options.classDistance, this.options.datatypeDistance);
