module.exports = function (graph) {
    ...
    Class_dragger.drawNode = function () {
        ...
        let pathData = "M 20,40 C 0,15 0,-15 20,-40 L -40,0 Z";
        // let pathData="M 20,40 C 0,15 0,-15 20,-40 20,-40 -35.22907,-23.905556 -45.113897,0.06313453 -35.22907,20.095453 20,40 20,40 Z";
        // let pathData="M 39.107144,51.25 C 0,17.362169 0,-13.75 39.285715,-49.821429 c 0,0 -69.58321,34.511175 -100.714286,50.35714329 C -22.96643,20.324376 39.107144,51.25 39.107144,51.25 Z";
    ...
    Class_dragger.updateElement = function () {
        ...
        if (Class_dragger.pathElement) {
            ...
            let ppX = sX + nX * Class_dragger.parent.actualRadius();
            let ppY = sY + nY * Class_dragger.parent.actualRadius();
        ...
        let angle = Math.atan2(Class_dragger.parent.y - Class_dragger.y, Class_dragger.parent.x - Class_dragger.x) * 180 / Math.PI;
    ...
    Class_dragger.mouseDown = function (event) {
    ...
    Class_dragger.mouseUp = function (event) {
    ...
    Class_dragger.onMouseOver = function (event) {
        if (Class_dragger.mouseEntered()) {
            return;
        }
        Class_dragger.nodeElement.classed("classDraggerNode", false);
        Class_dragger.nodeElement.classed("classDraggerNodeHovered", true);
        let selectedNode = Class_dragger.rootElement.node(),
    ...
    Class_dragger.onMouseOut = function (event) {
