module.exports = function (graph) {
    ...
    Range_dragger.mouseEnteredlet = false;
    ...
    Range_dragger.updateRange = function (newRange) {
        ...
        let dX = Range_dragger.parent.domain().x;
        let dY = Range_dragger.parent.domain().y;
    ...
    Range_dragger.drawNode = function () {
        ...
        let pathData = "M 61,40 C 41,15 41,-15 61,-40 L 1,0 Z";
    ...
    Range_dragger.updateElementViaDomainDragger = function (x, y) {
        ...
        let dex = Range_dragger.parent.range().x;
        let dey = Range_dragger.parent.range().y;
        ...
        let ep_range_x = dex + nX * Range_dragger.parent.range().actualRadius();
        let ep_range_y = dey + nY * Range_dragger.parent.range().actualRadius();
        ...
        let doX = ep_range_x + nX * 40;
        let doY = ep_range_y + nY * 40;
    ...
    Range_dragger.addMouseEvents = function () {
        let rootLayer = Range_dragger.rootNodeLayer.selectAll("*");
    ...
    Range_dragger.mouseEntered = function (p) {
        if (!arguments.length) return Range_dragger.mouseEnteredlet;
        Range_dragger.mouseEnteredlet = p;
    ...
    Range_dragger.onMouseOver = function () {
        ...
        Range_dragger.nodeElement.classed("classDraggerNodeHovered", true);
        let selectedNode = Range_dragger.rootElement.node(),
    ...
    Range_dragger.setPosition = function (x, y) {
        let range_x = Range_dragger.parent.domain().x;
        let range_y = Range_dragger.parent.domain().y;
