...
module.exports = (function () {
    ...
    let Base = function (graph) {
        ...
        this.isPropertyAssignedToThisElement = function (property) {
            ...
            if (property.type() === "rdfs:subClassOf")
                for (let i = 0; i < assignedProperties.length; i++) {
                    let iriEl = assignedProperties[i].iri();
        ...
        this.raiseDoubleClickEdit = function (event, forceIRISync) {
            ...
            editText.on("mousedown", function (event) {
                ...
                .on("blur", function (event) {
                    ...
                    if (backupFullIri) {
                        let sanityCheckResult = graph.checkIfIriClassAlreadyExist(backupFullIri);
        ...
        that.collectCssClasses = function () {
            ...
            return cssClasses.concat(that.visualAttributes());;
        };
        ...
        this.foreground = function () {
            let selectedNode = that.nodeElement().node(),
