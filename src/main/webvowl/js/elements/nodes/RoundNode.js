...
module.exports = (function () {
    ...
    let o = function (graph) {
        ...
        this.textWidth = function (yOffset) {
            ...
            if (yOffset) {
                let relativeOffset = Math.abs(yOffset) / this.actualRadius();
                let isOffsetInsideOfNode = relativeOffset <= 1;
        ...
        this.drawPin = function () {
            that.pinned(true);
            let dx = (-3.5 / 5) * that.actualRadius(),
        ...
        function createTextBlock() {
            ...
            let textBlock = new CenteringTextElement(that.nodeElement(), bgColor);
        ...
        this.equivalentsString = function () {
            let equivalentClasses = that.equivalents();
