...
function Label(property, link) {
  ...
  Object.defineProperty(this, "fixed", {
    get: function () {
      let inverseFixed = property.inverse() ? property.inverse().fixed : false;
...
Label.prototype.equals = function (other) {
  ...
  let instance = other instanceof Label;
  let equalProperty = this.property().equals(other.property());
