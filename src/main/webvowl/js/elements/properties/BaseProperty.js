...
export default class BaseProperty extends RectangularElementToolsMixin(BaseElement) {
    /**
     * @param {Graph} graph
     */
    constructor(graph) {
        ...
        editText.on("mousedown", function () {
            ...
            .on("blur", function () {
                ...
                if (_this.backupFullIri) {
                    ...
                    const sanityCheckResult = _this.graph.options.editSidebar.checkProperIriChange(this, _this.backupFullIri);
