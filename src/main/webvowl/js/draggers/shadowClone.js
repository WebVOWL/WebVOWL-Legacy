...
export class ShadowClone extends AbstractDragger {
    ...
    setParentProperty(parentProperty, inverted) {
        ...
        this.pathElement.attr("x1", this.e_x)
            .attr("y1", this.e_y)
            .attr("x2", this.s_x)
            .attr("y2", this.s_y);
        ...
        if (parentProperty.markerElement) {
            this.markerElement.attr("viewBox", parentProperty.markerElement.attr("viewBox"))
            ...
            this.markerElement.append("path")
                .attr("d", markerPath.attr("d"))
                .classed(parentProperty.markerType, true);
            this.pathElement.attr("marker-end", "url(#" + "shadowCloneMarker" + ")");
            this.markerElement.classed("hidden", !ElementTools.isDatatypeProperty(parentProperty));
        }
        const rect = this.rootNodeLayer.append("rect")
        ...
        const textElement = new CenteringTextElement(this.rootNodeLayer, bgColor);
